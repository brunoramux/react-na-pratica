          ...
          <div className="flex items-center">
            <Input variant='filter'>
              ...
              <Control 
                ...
                onChange={e => setFilter(e.target.value)} // fica colocando o que esta no input dentro da variavel filter
                value={filter}
              />
            </Input>
            <Button onClick={handleFilter} /* funcao para setar parametros com dados do input */ >  
